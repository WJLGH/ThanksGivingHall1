...
public class FinAccountAddModelImpl implements FinAccountAddContract.Model {
    public String baseUrl = "";

    public FinAccountAddModelImpl(String baseUrl) {
        this.baseUrl = baseUrl;
    }

    @Override
    public void request(RequestBody body, final ResultListener<Base> result) {
        Call<Base> call = AppMainService.getFinAccountService(baseUrl).addFinAccount(body);
        result.onStart();
